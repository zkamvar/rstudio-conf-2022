...
The workbench uses {renv} in the background for R lessons so that the lessons
come with batteries included. Importantly, when developing a lesson, you do not need to know how to use {renv} to work with the lesson. 
...
With the workbench we want to make sure they set people up for success and
...
Moreover, pull request rendering of markdown intermediate outputs allows 
contributors to inspect R code changes before they become live.
